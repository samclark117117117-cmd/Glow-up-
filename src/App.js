...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=Crimson+Text:ital@0;1&display=swap'); *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent} @keyframes blob{0%,100%{transform:translateY(0);opacity:.1}50%{transform:translateY(-16px);opacity:.17}} @keyframes shimmer{0%,100%{background-position:0% 50%}50%{background-position:100% 50%}} @keyframes popIn{0%{transform:scale(.86) translateY(14px);opacity:0}100%{transform:scale(1) translateY(0);opacity:1}} @keyframes fly{0%{transform:scale(0) rotate(0deg);opacity:1}100%{transform:scale(2) rotate(720deg) translateY(-100px);opacity:0}} @keyframes pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.07)}} @keyframes up{from{transform:translateY(20px);opacity:0}to{transform:translateY(0);opacity:1}} @keyframes lvlPop{0%{transform:scale(0) translateY(40px);opacity:0}65%{transform:scale(1.06);opacity:1}100%{transform:scale(1);opacity:1}} @keyframes tick{0%{transform:scale(1)}40%{transform:scale(1.4)}100%{transform:scale(1)}} @keyframes achSlide{0%{transform:translateY(-70px) translateX(-50%);opacity:0}15%,80%{transform:translateY(0) translateX(-50%);opacity:1}100%{transform:translateY(-70px) translateX(-50%);opacity:0}} @keyframes splFade{0%{opacity:1}100%{opacity:0}} ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:rgba(255,100,180,.22);border-radius:3px}`}</style>
