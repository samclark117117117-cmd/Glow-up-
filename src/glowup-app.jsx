...
export default function App() {
  ...
  function renderAdminSettings() {
    ...
    return <div>{themeCard}{notifCard}{milestoneCard}{onboardCard}{dangerCard}<button onClick={function(){setSt(function(p){return Object.assign({},p,{unlocked:false,view:'her'});});}} style={Object.assign({},sbS(false),{width:'100%',padding:'11px'})}>Lock and Return</button></div>;
  }
