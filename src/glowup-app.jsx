...
async function supaSave(data) {
  try {
    await fetch(SUPA_URL + '/rest/v1/glowup_data', { method: 'POST', headers: { 'apikey': SUPA_KEY, 'Authorization': 'Bearer ' + SUPA_KEY, 'Content-Type': 'application/json', 'Prefer': 'resolution=merge-duplicates' }, body: JSON.stringify({ id: 'shared', data: data, updated_at: new Date().toISOString() }) });
  } catch(e) {}
}
...
const CHALLENGES = [
  ...
  {id:'c01',emoji:'🦋',title:'Mirror Moment',description:'Spend 10 minutes looking at yourself in the mirror with no clothes on. Find 5 things you genuinely love about what you see. Say them out loud.',category:'Confidence',level:1},
  {id:'c02',emoji:'🦋',title:'Wear Something That Shows Your Figure',description:'Wear something that shows your figure today and catch every reflection confidently. Do not adjust it or cover up. You look incredible.',category:'Confidence',level:1},
  {id:'c03',emoji:'🦋',title:'Full Length Photo',description:'Take a full length photo of yourself in your favourite outfit today and actually look at it properly. Do not delete it.',category:'Confidence',level:1},
  {id:'c04',emoji:'🦋',title:'Body Ritual',description:'Moisturise your entire body slowly and deliberately after your shower today. Treat it like a ritual. Every part of you deserves attention.',category:'Confidence',level:1},
  {id:'c05',emoji:'🦋',title:'Sexiest Underwear All Day',description:'Wear your sexiest underwear today for absolutely no reason at all. You do not need an occasion. Wear it for you.',category:'Confidence',level:1},
  {id:'c06',emoji:'🦋',title:'Dress Before Anyone Wakes Up',description:'Do your full hair and makeup before anyone else is up today. Just for yourself. Because you deserve to start the day feeling beautiful.',category:'Confidence',level:2},
  {id:'c07',emoji:'🦋',title:'Own Every Room',description:'Today you walk into every space knowing you are the most attractive woman in it. Not arrogant. Just certain. Carry yourself accordingly.',category:'Confidence',level:2},
  {id:'c08',emoji:'🦋',title:'Irresistible Outfit',description:'Wear something today that makes you feel completely irresistible and go about your day as if that is completely normal. Because it is.',category:'Confidence',level:2},
  {id:'c09',emoji:'🦋',title:'Bedtime Mirror',description:'Before you get into bed tonight, look at yourself in the mirror and say something genuinely kind out loud. Not a thought. Out loud.',category:'Confidence',level:1},
  {id:'c10',emoji:'🦋',title:'Walk Like You Are Being Filmed',description:'Walk everywhere today as if there is a camera on you. Slow, deliberate, completely comfortable in your own body. Every step.',category:'Confidence',level:2},
  {id:'c11',emoji:'🦋',title:'No Hiding Today',description:'Wear something that shows skin or your shape today and do not pull it down, cross your arms or apologise for it once. Own all of it.',category:'Confidence',level:3},
  {id:'c12',emoji:'🦋',title:'Enjoy Being Looked At',description:'Every time you notice someone look at you today, let yourself enjoy it. Do not shrink. Do not look away first. You look beautiful and you know it.',category:'Confidence',level:3},
  {id:'c13',emoji:'🦋',title:'Touch Yourself Slowly',description:'Spend 5 minutes today just running your hands over your own body. No rush. Learn to appreciate what you feel like. You are stunning.',category:'Confidence',level:3},
  {id:'c14',emoji:'🦋',title:'You Are a Beautiful Thing',description:'Say out loud in the mirror today — I am beautiful, I am desirable, I am worth looking at. Say it until you mean every word.',category:'Confidence',level:3},
  {id:'c15',emoji:'🦋',title:'Dress to Be Undressed',description:'Today choose your outfit with one thought in mind — looking incredible when it comes off. Matching underwear. Everything deliberate.',category:'Confidence',level:4},
  {id:'dv01',emoji:'🩷',title:'Good Morning First',description:'Send him a good morning message before you look at anything else on your phone today. He gets the first thing you do.',category:'Devotion',level:1},
  {id:'dv02',emoji:'🩷',title:'Tell Him Your Plans',description:'Before you start your day, tell him what you are doing today. All of it. Let him feel like he is part of your day even from a distance.',category:'Devotion',level:1},
  {id:'dv03',emoji:'🩷',title:'Photo Before You Leave',description:'Send him a photo of how you look before you leave the house today. He should see you looking beautiful every single day.',category:'Devotion',level:1},
  {id:'dv04',emoji:'🩷',title:'Check In Every 2 Hours',description:'Send him a message every 2 hours today just to let him know what you are doing and that you are thinking about him.',category:'Devotion',level:1},
  {id:'dv05',emoji:'🩷',title:'Tell Him Three Times',description:'Tell him three times today that you are thinking about him. Unprompted. Specific. Genuine. Not just an emoji.',category:'Devotion',level:1},
  {id:'dv06',emoji:'🩷',title:'Ask What to Wear',description:'Ask him what he wants you to wear today and wear it without question. No negotiating. His choice, your body.',category:'Devotion',level:2},
  {id:'dv07',emoji:'🩷',title:'Reply Within 10 Minutes',description:'Reply to every single one of his messages within 10 minutes today. No exceptions. He is your priority.',category:'Devotion',level:2},
  {id:'dv08',emoji:'🩷',title:'Complete Everything Today',description:'Complete every single challenge today and send him proof. All of them. Show him you are taking this seriously.',category:'Devotion',level:2},
  {id:'dv09',emoji:'🩷',title:'Do Not Question It',description:'If he gives you any instruction today, do it without questioning it once. Trust him. That is what devotion looks like.',category:'Devotion',level:2},
  {id:'dv10',emoji:'🩷',title:'Cook or Prepare Something',description:'Cook or prepare something for him before his next visit. Something he will love. Think about him the whole time you make it.',category:'Devotion',level:2},
  {id:'dv11',emoji:'🩷',title:'Voice Note',description:'Send him a voice note today instead of a text. Let him hear your voice. Tell him something you would only ever say to him.',category:'Devotion',level:2},
  {id:'dv12',emoji:'🩷',title:'Something You Have Never Said',description:'Tell him something today that you have never told him before. Something real. Something that took courage to say.',category:'Devotion',level:3},
  {id:'dv13',emoji:'🩷',title:'Plan Your Next Visit',description:'Send him dates, ideas and plans for your next visit today. Be specific. Show him you are as excited to see him as he is to see you.',category:'Devotion',level:2},
  {id:'dv14',emoji:'🩷',title:'Remind Yourself Who You Belong To',description:'Three times today, say out loud that you are his. In the mirror. Alone. Mean it every time.',category:'Devotion',level:3},
  {id:'dv15',emoji:'🩷',title:'His Permission',description:'Ask his permission before making any decision today — even small ones. Let him be in control. See how it feels.',category:'Devotion',level:4},
  ...
  {id:'f01',emoji:'💋',title:'Send Something He Cannot Forget',description:'Send him a photo today that he will not be able to stop thinking about. You decide what that means. Make it count.',category:'Flirty',level:2},
  {id:'f02',emoji:'💋',title:'Tell Him What You Want',description:'Text him exactly what you want him to do to you the next time you see him. In detail. Do not be shy about it.',category:'Flirty',level:2},
  {id:'f03',emoji:'💋',title:'Wear Something Dangerous',description:'Wear something today that would make him completely lose focus if he saw you in it. Then tell him what you are wearing.',category:'Flirty',level:2},
  {id:'f04',emoji:'💋',title:'Go Quiet Then Come Back',description:'Be completely unavailable for one hour today — no replies to anyone. Then come back looking incredible and act like nothing happened.',category:'Flirty',level:3},
  {id:'f05',emoji:'💋',title:'No Words',description:'Send him one message today with absolutely no words. Just a photo. Let him figure out the rest.',category:'Flirty',level:3},
  {id:'f06',emoji:'💋',title:'Red Everything',description:'Wear as much red as possible today — lips, nails, outfit, whatever you can do. Red is a message. Send it.',category:'Flirty',level:2},
  {id:'f07',emoji:'💋',title:'Think About Him Every Hour',description:'Think about him every single hour today. At the end of the day, tell him that you did and what you were thinking.',category:'Flirty',level:2},
  {id:'f08',emoji:'💋',title:'Make Him Feel Lucky',description:'Make him feel like the luckiest man alive in one message before midday. Mean every word of it.',category:'Flirty',level:2},
  {id:'f09',emoji:'💋',title:'Wear His Favourite',description:'Wear his favourite thing on you today. The outfit, the perfume, the underwear — whatever it is that makes him lose his mind.',category:'Flirty',level:2},
  {id:'f10',emoji:'💋',title:'Send Proof Before You Leave',description:'Do your full hair and makeup and send him proof before you leave the house today. He should see what everyone else gets to see.',category:'Flirty',level:1},
  {id:'f11',emoji:'💋',title:'Eye Contact Too Long',description:'Maintain eye contact with someone today a beat longer than feels natural. Hold it. Smile slowly. Walk away first.',category:'Flirty',level:3},
  {id:'f12',emoji:'💋',title:'Leave While You Are Winning',description:'If you are out today, leave before the night ends while you are still the most interesting and best looking person there.',category:'Flirty',level:4},
  {id:'n01',emoji:'😈',title:'Wear Matching Lingerie All Day',description:'Wear a matching lingerie set under your outfit today and do not tell him until the end of the day. Then tell him exactly what you were wearing all day.',category:'Naughty',level:1},
  {id:'n02',emoji:'😈',title:'Sleep in Nothing',description:'Sleep in absolutely nothing tonight. Tell him before you go to bed.',category:'Naughty',level:1},
  {id:'n03',emoji:'😈',title:'Send a Photo With No Caption',description:'Take a mirror selfie in just your underwear and send it to him with absolutely no caption. Let him respond.',category:'Naughty',level:2},
  {id:'n04',emoji:'😈',title:'Tell Him Your Fantasies',description:'Write out your three biggest fantasies and send them to him today. All three. Do not leave anything out.',category:'Naughty',level:2},
  {id:'n05',emoji:'😈',title:'Nothing Under Your Outfit',description:'Wear nothing under your outfit today. Go about your day completely normally. Tell him at the end of the day.',category:'Naughty',level:2},
  {id:'n06',emoji:'😈',title:'Voice Note',description:'Record a voice note telling him in detail what you are thinking about right now. Send it. Do not re-record it.',category:'Naughty',level:2},
  {id:'n07',emoji:'😈',title:'Send a Video',description:'Send him a video today — face included. Just for him. Something he will want to watch more than once.',category:'Naughty',level:3},
  {id:'n08',emoji:'😈',title:'Edge Yourself',description:'Edge yourself thinking about him today and do not finish without his permission. Tell him what you did.',category:'Naughty',level:3},
  {id:'n09',emoji:'😈',title:'Ask Permission',description:'Ask his permission before you orgasm today. If you cannot reach him you wait. No exceptions.',category:'Naughty',level:3},
  {id:'n10',emoji:'😈',title:'Do Not Touch Yourself',description:'Do not touch yourself today unless he says you can. Tell him at the end of the day that you did not.',category:'Naughty',level:3},
  {id:'n11',emoji:'😈',title:'Send Something Every Hour',description:'Send him a photo every hour for 3 hours today. Each one slightly more than the last. His choice what that means.',category:'Naughty',level:3},
  {id:'n12',emoji:'😈',title:'His Task This Morning',description:'Ask him to set you a task first thing this morning and complete it before midday. No excuses. No negotiating.',category:'Naughty',level:3},
  {id:'n13',emoji:'😈',title:'Write What You Want Him to Do',description:'Write out in detail exactly what you want him to do to you next time you see him and send it. Every detail.',category:'Naughty',level:3},
  {id:'n14',emoji:'😈',title:'Call Tonight',description:'Have a phone call with him tonight where you do exactly what he tells you to do. No questions.',category:'Naughty',level:4},
  {id:'n15',emoji:'😈',title:'Stay on the Phone',description:'Stay on the phone with him tonight until he says you can go. However long that is.',category:'Naughty',level:3},
  {id:'n16',emoji:'😈',title:'Do Not Touch All Week',description:'Do not touch yourself at all until he visits. Tell him every day that you have not. Let the anticipation build.',category:'Naughty',level:4},
  {id:'n17',emoji:'😈',title:'Call Him Sir',description:'Refer to him as sir in every single message today. Every one. Do not break it once.',category:'Naughty',level:3},
  {id:'n18',emoji:'😈',title:'Yes to Everything',description:'Whatever he asks for tonight the answer is yes. No hesitation. No negotiating.',category:'Naughty',level:4},
  {id:'n19',emoji:'😈',title:'He Picks Your Outfit',description:'He picks your outfit for today including your underwear. You wear exactly what he says without question.',category:'Naughty',level:3},
  {id:'n20',emoji:'😈',title:'24 Hours of Yes',description:'For the next 24 hours you do exactly what he asks without questioning it once. Trust him completely.',category:'Naughty',level:5},
  {id:'n21',emoji:'😈',title:'Send Proof',description:'Send him proof of every single challenge completed today. Every one. Show him you are taking this seriously.',category:'Naughty',level:2},
  {id:'n22',emoji:'😈',title:'Touch Yourself Thinking of Him',description:'Touch yourself thinking about him today and tell him about it afterwards in detail. Do not skip any part.',category:'Naughty',level:3},
  {id:'n23',emoji:'😈',title:'Buy Something New',description:'Buy something new to wear for him before his next visit. Send him a photo of it. Let him look forward to it.',category:'Naughty',level:2},
  {id:'n24',emoji:'😈',title:'You Belong to Him',description:'Say out loud every time you look in the mirror today that you belong to him. Every single time.',category:'Naughty',level:3},
  {id:'n25',emoji:'😈',title:'His Orgasms This Week',description:'Ask him to own your orgasms for the rest of this week. He decides when. You ask every time.',category:'Naughty',level:5},
];
...
const ACHIEVEMENTS = [
  ...
  {id:'a8',emoji:'🦋',title:'Body Queen',desc:'10 Confidence challenges done',check:function(s){return (s.cats.Confidence||0)>=10;}},
  {id:'a9',emoji:'📸',title:'Dare Devil',desc:'5 Dare challenges done',check:function(s){return (s.cats.Dare||0)>=5;}},
  {id:'a14',emoji:'🩷',title:'Devoted',desc:'10 Devotion challenges done',check:function(s){return (s.cats.Devotion||0)>=10;}},
  {id:'a15',emoji:'💋',title:'Flirt',desc:'5 Flirty challenges done',check:function(s){return (s.cats.Flirty||0)>=5;}},
  {id:'a16',emoji:'😈',title:'Naughty Girl',desc:'5 Naughty challenges done',check:function(s){return (s.cats.Naughty||0)>=5;}},
  {id:'a10',emoji:'💪',title:'First Session',desc:'Complete your first training session',check:function(s){return s.grindPoints>=20;}},
  {id:'a11',emoji:'🏋',title:'Gym Regular',desc:'250 Grind Points earned',check:function(s){return s.grindPoints>=250;}},
  {id:'a12',emoji:'⭐',title:'Perfect Week',desc:'Complete a perfect week',check:function(s){return (s.perfectWeeks||0)>=1;}},
  {id:'a13',emoji:'🎯',title:'Unstoppable',desc:'3 perfect weeks',check:function(s){return (s.perfectWeeks||0)>=3;}},
];
...
export default function App() {
  ...
  var [st, setSt] = useState({
    ...
    rewardForm: { emoji:'🎁', title:'', desc:'', pointType:'glow', cost:50 },
    rewardFormErr: '',
  });
    ...
    supaLoad().then(function(data) {
      if (data) {
        setSt(function(p){ return Object.assign({},p,{
          ...
          ch:data.ch||p.ch, lgd:data.lgd||p.lgd, seen:data.seen||p.seen, hist:data.hist||p.hist,
          streak:data.streak||p.streak, lsd:data.lsd||p.lsd, cats:data.cats||p.cats, earned:data.earned||p.earned,
          ...
          custom:data.custom||p.custom, ovr:data.ovr||p.ovr, weeklyData:data.weeklyData||p.weeklyData,
          perfectWeeks:data.perfectWeeks||p.perfectWeeks, pb:data.pb||p.pb, weekGoal:data.weekGoal||p.weekGoal,
          ...
          rewards:data.rewards||p.rewards,
          nutDaysLogged:data.nutDaysLogged||p.nutDaysLogged,
          msgd:data.msg||p.msg,
        }); });
  ...
  // Save
  useEffect(function() {
    var data = Object.assign({},{ glowPoints:st.glowPoints, grindPoints:st.grindPoints, ch:st.ch, lgd:st.lgd, seen:st.seen, hist:st.hist, streak:st.streak, lsd:st.lsd, cats:st.cats, earned:st.earned, msg:st.msg, reaction:st.reaction, theme:st.theme, wplan:st.wplan, pinSet:st.pinSet, pin:st.pin, custom:st.custom, ovr:st.ovr, weeklyData:st.weeklyData, perfectWeeks:st.perfectWeeks, pb:st.pb, weekGoal:st.weekGoal, challengeNudgeTime:st.challengeNudgeTime, trainingNudgeTime:st.trainingNudgeTime, rewards:st.rewards, nutDaysLogged:st.nutDaysLogged, tChecked:tChecked, ridesDone:ridesDone, nutChecked:nutChecked, waterMl:waterMl });
    saveLocal(data);
    var t = setTimeout(function(){ supaSave(data); }, 800);
    return function(){ clearTimeout(t); };
  }, [st.glowPoints,st.grindPoints,st.ch,st.lgd,st.seen,st.hist,st.streak,st.lsd,st.cats,st.earned,st.msg,st.reaction,st.theme,st.wplan,st.pinSet,st.pin,st.custom,st.ovr,st.weeklyData,st.perfectWeeks,st.pb,st.weekGoal,st.challengeNudgeTime,st.trainingNudgeTime,st.rewards,st.nutDaysLogged,tChecked,ridesDone,nutChecked,waterMl]);
  ...
  useEffect(function() {
    var interval = setInterval(function() {
      ...
      var lastFiredChallenge = localStorage.getItem('lastChallengeNudge');
      var lastFiredTraining = localStorage.getItem('lastTrainingNudge');
      if (hhmm === st.challengeNudgeTime && lastFiredChallenge !== today && Notification.permission === 'granted') {
        if (doneT < 2) { new Notification('Time to glow up! ✨', {body:'You still need to complete your challenges today 💖'}); localStorage.setItem('lastChallengeNudge', today); }
      }
      var tSession = SESSIONS[todayDayId];
      if (hhmm === st.trainingNudgeTime && lastFiredTraining !== today && Notification.permission === 'granted') {
        if ((tSession.isGym || tSession.isRide) && !isSessionDone(todayDayId)) { new Notification('Training reminder 💪', {body:'Your ' + tSession.title + ' session is not done yet!'}); localStorage.setItem('lastTrainingNudge', today); }
      }
    }, 60000);
  ...
  function isSessionDone(dayId) {
    var sess = SESSIONS[dayId];
    if (!sess) return false;
    // Check weeklyData.trainingSessions first — works for any day, not just today
    if (currentWeekData && currentWeekData.trainingSessions && currentWeekData.trainingSessions[dayId]) return true;
    // Fallback: for gym sessions check ticked exercises (only accurate for current view)
    if (sess.isGym) {
      var exCount = sess.exercises ? sess.exercises.length : 0;
      var doneCount = sess.exercises ? sess.exercises.filter(function(_,i){ return tChecked[dayId+'-'+i]; }).length : 0;
      return exCount > 0 && doneCount === exCount;
    }
    return false;
  }

  // Check and apply perfect week
  function checkAndApplyPerfectWeek(weekData) {
    if (weekData && weekData.perfectWeekApplied) return;
    var isPerfect = checkPerfectWeek(weekData, currentWeekDates);
    if (isPerfect && weekData && !weekData.perfectWeekApplied) {
      ...
      setSt(function(p) {
        ...
        var newGlow = p.glowPoints + Math.round(weekData.glowEarned * (PERFECT_WEEK_MULTIPLIER - 1));
        var newGrind = p.grindPoints + Math.round(weekData.grindEarned * (PERFECT_WEEK_MULTIPLIER - 1));
        var newPb = Object.assign({}, p.pb, {
          bestPerfectStreak: Math.max(p.pb.bestPerfectStreak || 0, newPerfectWeeks)
        });
      ...
      setTimeout(function(){ setShowPerfectWeek(false); }, 4000);
    }
  }
  ...
  function gen(base) {
    ...
    if (!picked || picked.length === 0) picked = pickChallenges(b.seen, b.glowPoints, b.ovr, b.custom);
  ...
  function complete(uid) {
    setSt(function(p) {
      ...
      // PBs
      var newPb = Object.assign({}, p.pb, {
        mostChallengesDay: Math.max(p.pb.mostChallengesDay||0, doneCount),
        bestGlowWeek: Math.max(p.pb.bestGlowWeek||0, wd[currentWeekStart].glowEarned),
      });
      var ns = Object.assign({},p,{ch:nc,glowPoints:newGlow,seen:ns2,celebId:nd?uid:null,confetti:conf,lvlUp:lu,hist:Object.assign({},p.hist,{[today]:nc}),streak:str,lsd:lsd,allDone:an&&nd,cats:ncc,weeklyData:wd,pb:newPb});
      return Object.assign({},ns,checkAch(ns));
    });
  ...
  function completeTrainingSession(dayId) {
    ...
    setSt(function(p) {
      ...
      var newPb = Object.assign({}, p.pb, {
        bestGrindWeek: Math.max(p.pb.bestGrindWeek||0, weekGrindEarned),
      });
  ...
  // Auto-complete gym session when all exercises ticked
  ...
  useEffect(function() {
    // Only award points if session not already recorded in weeklyData
    var alreadyAwarded = !!(currentWeekData && currentWeekData.trainingSessions && currentWeekData.trainingSessions[tDay]);
    if (tAllDone && !prevAllDone.current && tSession.isGym && !alreadyAwarded) {
      completeTrainingSession(tDay);
    }
    prevAllDone.current = tAllDone;
  }, [tAllDone, tDay]);

  // Check perfect week whenever weekly data updates
  useEffect(function() {
    if (currentWeekData && !currentWeekData.perfectWeekApplied) {
      checkAndApplyPerfectWeek(currentWeekData);
    }
  ...
  function OVL(props) {
    return <div onClick={props.onClose} style={{position:'fixed',inset:0,background:'rgba(0,0,0,.88)',backdropFilter:'blur(10px)',zIndex:200,display:'flex',alignItems:'center',justifyContent:'center',padding:'20px'}}><div onClick={function(e){e.stopPropagation();}} style={{maxWidth:400,width:'100%'}}>{props.children}</div></div>;
  }

  // ── Week wrap data ──
  var weekWrapData = st.weeklyData[currentWeekStart] || { challenges:{}, trainingSessions:{}, glowEarned:0, grindEarned:0, perfectWeekApplied:false };
  var weekGlowBase = weekWrapData.glowEarned || 0;
  var weekGrindBase = weekWrapData.grindEarned || 0;
  var weekGlowTotal = weekWrapData.perfectWeekApplied ? Math.round(weekGlowBase * 1.5) : weekGlowBase;
  var weekGrindTotal = weekWrapData.perfectWeekApplied ? Math.round(weekGrindBase * 1.5) : weekGrindBase;
    ...
    <div style={{minHeight:'100vh',background:T.bg,fontFamily:'Palatino Linotype,Palatino,Georgia,serif',position:'relative',overflow:'hidden'}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent}
        ...
        @keyframes perfectPop{0%{transform:scale(0) rotate(-5deg);opacity:0}60%{transform:scale(1.08) rotate(1deg);opacity:1}100%{transform:scale(1) rotate(0deg);opacity:1}}
      ...
      {showPerfectWeek && (
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,.85)',backdropFilter:'blur(8px)',zIndex:350,display:'flex',alignItems:'center',justifyContent:'center',padding:'20px'}}>
          <div style={{background:'linear-gradient(135deg,rgba(22,0,15,.97),rgba(38,0,24,.97))',border:'1px solid '+T.a1+'66',borderRadius:26,padding:'44px 32px',textAlign:'center',animation:'perfectPop .6s ease-out',maxWidth:320,width:'100%',boxShadow:'0 0 60px '+T.a1+'44'}}>
      ...
      <div style={{position:'relative',zIndex:1,maxWidth:520,margin:'0 auto',padding:'0 0 90px'}}>
        ...
        {tab==='home' && (
          <div style={{padding:'0 15px'}}>
              ...
              <div style={{display:'flex',gap:8,justifyContent:'center',marginTop:14,flexWrap:'wrap'}}>
                <div style={{display:'inline-flex',alignItems:'center',gap:9,background:T.a1+'12',border:'1px solid '+T.a1+'22',borderRadius:50,padding:'9px 18px'}}>
                  ...
                  <div style={{textAlign:'left'}}>
                    <div style={{color:glowLvi.color,fontWeight:'bold',fontFamily:'Playfair Display,serif',fontSize:'0.86rem'}}>{glowLvi.title}</div>
                    <div style={{color:'rgba(255,179,217,.3)',fontSize:'0.58rem'}}>✨ {st.glowPoints} Glow Pts</div>
                  </div>
                </div>
                <div style={{display:'inline-flex',alignItems:'center',gap:9,background:'rgba(255,45,120,.08)',border:'1px solid rgba(255,45,120,.2)',borderRadius:50,padding:'9px 18px'}}>
                  ...
                  <div style={{textAlign:'left'}}>
                    <div style={{color:grindLvi.color,fontWeight:'bold',fontFamily:'Playfair Display,serif',fontSize:'0.86rem'}}>{grindLvi.title}</div>
                    <div style={{color:'rgba(255,179,217,.3)',fontSize:'0.58rem'}}>💪 {st.grindPoints} Grind Pts</div>
                  </div>
                </div>
              </div>

              {/* Streak */}
              {st.streak>0 && <div style={{display:'inline-flex',alignItems:'center',gap:6,background:'rgba(255,179,71,.08)',border:'1px solid rgba(255,179,71,.2)',borderRadius:50,padding:'7px 14px',marginTop:8}}><span>🔥</span><div style={{color:'#ffb347',fontWeight:'bold',fontFamily:'Playfair Display,serif',fontSize:'0.86rem'}}>{st.streak} day streak</div></div>}
              ...
              <div style={{margin:'12px 0 0',padding:'0 4px'}}>
                <div style={Object.assign({},cardS,{padding:'12px 16px',display:'flex',justifyContent:'space-between',alignItems:'center'})}>
                  ...
                  <div style={{textAlign:'right'}}>
                    {weekWrapData.perfectWeekApplied && <div style={{background:'linear-gradient(135deg,'+T.a1+','+T.a2+')',borderRadius:20,padding:'4px 10px',fontSize:'0.68rem',fontWeight:700,color:'#fff',marginBottom:4}}>🏆 1.5x!</div>}
            ...
            {/* Week Wrap modal */}
            {showWeekWrap && (
              <OVL onClose={function(){setShowWeekWrap(false);}}>
                <div style={Object.assign({},cardS,{padding:'24px',animation:'popIn .3s ease-out',border:'1px solid '+T.a1+'44',maxHeight:'85vh',overflowY:'auto'})}>
                  ...
                  <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.7rem',marginBottom:16,fontFamily:'Crimson Text,serif'}}>{currentWeekStart}</div>
                  {/* Daily breakdown */}
                  {currentWeekDates.map(function(dateStr) {
                    var dayCh = weekWrapData.challenges[dateStr] || [];
                    var doneCh = dayCh.filter(function(c){return c.done;}).length;
                    var d = new Date(dateStr);
                    var dayId = dayMap[d.getDay()];
                    var sess = SESSIONS[dayId];
                    var sessRequired = sess && (sess.isGym || sess.isRide);
                    var sessDone = weekWrapData.trainingSessions[dayId];
                    var isPerfectDay = doneCh >= 3 && (!sessRequired || sessDone);
                    return (
                      <div key={dateStr} style={{display:'flex',alignItems:'center',gap:10,padding:'9px 0',borderBottom:'1px solid rgba(255,120,190,.08)'}}>
                        <div style={{width:36,textAlign:'center'}}>
                          <div style={{fontSize:'0.68rem',fontWeight:'bold',color:isPerfectDay?T.a1:'rgba(255,179,217,.35)',fontFamily:'Playfair Display,serif'}}>{DAYS_SHORT[d.getDay()]}</div>
                          <div style={{fontSize:'0.58rem',color:'rgba(255,179,217,.25)'}}>{d.getDate()}/{d.getMonth()+1}</div>
                        </div>
                        <div style={{flex:1}}>
                          <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
                            <span style={{fontSize:'0.7rem',color:doneCh>=2?T.a1:'rgba(255,179,217,.3)'}}>✨ {doneCh} challenges</span>
                            {sessRequired && <span style={{fontSize:'0.7rem',color:sessDone?'#ff3d9a':'rgba(255,179,217,.3)'}}>💪 {sessDone?'done':'missed'}</span>}
                            {!sessRequired && <span style={{fontSize:'0.7rem',color:'rgba(255,179,217,.25)'}}>rest day</span>}
                          </div>
                        </div>
                        <div style={{fontSize:'1rem'}}>{isPerfectDay?'⭐':dateStr===today?'…':new Date(dateStr)>new Date(today)?'':' '}</div>
                      </div>
                    );
                  })}
                  {/* Points summary */}
                  <div style={{marginTop:14,padding:'12px',background:'rgba(255,255,255,.03)',borderRadius:12,border:'1px solid rgba(255,120,190,.1)'}}>
                    <div style={{display:'flex',justifyContent:'space-between',marginBottom:6}}>
                      <span style={{color:'rgba(255,179,217,.5)',fontSize:'0.8rem'}}>Glow Points earned</span>
                      <span style={{color:T.a1,fontWeight:'bold',fontSize:'0.8rem'}}>{weekGlowBase}{weekWrapData.perfectWeekApplied?' → '+weekGlowTotal:''}</span>
                    </div>
                    <div style={{display:'flex',justifyContent:'space-between',marginBottom:6}}>
                      <span style={{color:'rgba(255,179,217,.5)',fontSize:'0.8rem'}}>Grind Points earned</span>
                      <span style={{color:'#ff3d9a',fontWeight:'bold',fontSize:'0.8rem'}}>{weekGrindBase}{weekWrapData.perfectWeekApplied?' → '+weekGrindTotal:''}</span>
                    </div>
                    {weekWrapData.perfectWeekApplied && <div style={{color:T.a1,fontSize:'0.78rem',fontStyle:'italic',textAlign:'center',marginTop:6}}>🏆 1.5x perfect week multiplier applied!</div>}
                    {!weekWrapData.perfectWeekApplied && <div style={{color:'rgba(255,179,217,.35)',fontSize:'0.72rem',textAlign:'center',marginTop:6}}>Complete all sessions + 2 challenges/day for 1.5x bonus</div>}
                  </div>
              ...
              <div style={{animation:'up .4s ease-out'}}>
                        ...
                        return <div key={c.uid} style={Object.assign({},cardS,{padding:'18px',animation:'popIn .4s '+(i*.12)+'s ease-out both',border:c.done?'1px solid '+T.a1+'36':'1px solid rgba(255,120,190,.13)',background:c.done?T.a1+'07':'rgba(255,255,255,.035)',position:'relative',overflow:'hidden'})}>
                          ...
                          <div style={{display:'flex',alignItems:'flex-start',gap:12,paddingLeft:7}}>
                            ...
                            <div style={{flex:1,minWidth:0}}>
                              ...
                              {c.done && <div style={{marginTop:6,fontSize:'0.7rem',color:T.a1,fontFamily:'Crimson Text,serif'}}>+{GLOW_PER_CHALLENGE} ✨ Glow Points</div>}
                ...
                {st.htab==='Stats' && (
                  <div style={{animation:'up .35s ease-out'}}>
                    ...
                    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:14}}>
                      <div style={Object.assign({},cardS,{padding:'16px 12px',textAlign:'center',border:'1px solid '+T.a1+'33'})}>
                        <div style={{fontSize:'1.8rem',marginBottom:5}}>{glowLvi.emoji}</div>
                        <div style={{color:glowLvi.color,fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1rem'}}>{glowLvi.title}</div>
                        <div style={{color:T.a1,fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1.4rem',marginTop:2}}>{st.glowPoints}</div>
                        <div style={{color:'rgba(255,179,217,.32)',fontSize:'0.6rem',textTransform:'uppercase',letterSpacing:'0.07em'}}>Glow Points</div>
                      </div>
                      <div style={Object.assign({},cardS,{padding:'16px 12px',textAlign:'center',border:'1px solid rgba(255,45,120,.22)'})}>
                        <div style={{fontSize:'1.8rem',marginBottom:5}}>{grindLvi.emoji}</div>
                        <div style={{color:grindLvi.color,fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1rem'}}>{grindLvi.title}</div>
                        <div style={{color:'#ff3d9a',fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1.4rem',marginTop:2}}>{st.grindPoints}</div>
                        <div style={{color:'rgba(255,179,217,.32)',fontSize:'0.6rem',textTransform:'uppercase',letterSpacing:'0.07em'}}>Grind Points</div>
                      </div>
                    </div>
                    {/* Other stats */}
                    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:14}}>
                      {[{e:'🔥',v:st.streak,l:'Day Streak'},{e:'🏆',v:st.perfectWeeks||0,l:'Perfect Weeks'},{e:'✨',v:st.pb.bestGlowWeek||0,l:'Best Glow Week'},{e:'💪',v:st.pb.bestGrindWeek||0,l:'Best Grind Week'}].map(function(s,i){
                ...
                {st.htab==='History' && (
                  <div style={{animation:'up .35s ease-out'}}>
                    ...
                    : hdates.map(function(date){ var dc=st.hist[date]||[]; var dd=dc.filter(function(c){return c.done;}).length; var pf=dd>=2;
            ...
            {st.view==='admin' && st.unlocked && (
              <div style={{animation:'up .4s ease-out'}}>
                <div style={{display:'flex',gap:5,marginBottom:14,overflowX:'auto',padding:'2px 0'}}>
                  {['Today','Challenges','Planner','Add New','Bulk Import','Week','Rewards','Settings'].map(function(t){ return <button key={t} style={Object.assign({},sbS(st.atab===t),{flex:1,minWidth:'fit-content',padding:'8px 9px',fontSize:'0.7rem'})} onClick={function(){setSt(function(p){return Object.assign({},p,{atab:t});});}}>{t}</button>; })}
                </div>
                ...
                {st.atab==='Today' && (
                  <div>
                    ...
                    <p style={{color:'rgba(255,179,217,.24)',fontSize:'0.7rem',textAlign:'center',marginBottom:13,fontStyle:'italic'}}>Picks 3 fresh challenges at her current Glow level</p>
                ...
                {st.atab==='Week' && (
                  <div>
                    ...
                    <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.72rem',marginBottom:14,fontFamily:'Crimson Text,serif'}}>Current week — {currentWeekStart}</div>

                    {/* Points overview */}
                    <div style={Object.assign({},cardS,{padding:'14px',marginBottom:12})}>
                      <div style={{display:'flex',justifyContent:'space-between',marginBottom:10}}>
                        <div style={{textAlign:'center'}}>
                          <div style={{color:T.a1,fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1.4rem'}}>{weekGlowTotal}</div>
                          <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.6rem',textTransform:'uppercase'}}>Glow Points</div>
                          {weekWrapData.perfectWeekApplied&&<div style={{color:T.a1,fontSize:'0.6rem'}}>(was {weekGlowBase})</div>}
                        </div>
                        <div style={{textAlign:'center'}}>
                          <div style={{color:'#ff3d9a',fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1.4rem'}}>{weekGrindTotal}</div>
                          <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.6rem',textTransform:'uppercase'}}>Grind Points</div>
                          {weekWrapData.perfectWeekApplied&&<div style={{color:'#ff3d9a',fontSize:'0.6rem'}}>(was {weekGrindBase})</div>}
                        </div>
                        <div style={{textAlign:'center'}}>
                          <div style={{color:'#ffb347',fontFamily:'Playfair Display,serif',fontWeight:'bold',fontSize:'1.4rem'}}>{weekWrapData.perfectWeekApplied?'🏆':'—'}</div>
                          <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.6rem',textTransform:'uppercase'}}>Perfect Week</div>
                        </div>
                      </div>
                    </div>
                    ...
                    {currentWeekDates.map(function(dateStr) {
                      ...
                      var sessRequired = sess && (sess.isGym || sess.isRide);
                      var sessDone = weekWrapData.trainingSessions[dayId];
                      var glowEarned = doneCh * GLOW_PER_CHALLENGE;
                      var grindEarned = sessDone ? (sess.isGym ? GRIND_GYM : GRIND_RIDE) : 0;
                      return (
                        <div key={dateStr} style={Object.assign({},cardS,{padding:'11px 14px',marginBottom:8,opacity:dateStr>today?.45:1})}>
                          <div style={{display:'flex',alignItems:'center',gap:10}}>
                            <div style={{minWidth:40}}>
                              <div style={{color:'#ffe8f5',fontFamily:'Playfair Display,serif',fontSize:'0.82rem',fontWeight:'bold'}}>{DAYS_SHORT[d.getDay()]}</div>
                              <div style={{color:'rgba(255,179,217,.3)',fontSize:'0.62rem'}}>{d.getDate()}/{d.getMonth()+1}</div>
                            </div>
                            <div style={{flex:1}}>
                              <div style={{display:'flex',gap:8,flexWrap:'wrap',marginBottom:4}}>
                                <span style={{fontSize:'0.72rem',color:doneCh>=2?T.a1:'rgba(255,179,217,.35)'}}>✨ {doneCh} challenge{doneCh!==1?'s':''}</span>
                                {sessRequired && <span style={{fontSize:'0.72rem',color:sessDone?'#ff3d9a':'rgba(255,179,217,.35)'}}>💪 {sess.title} {sessDone?'✓':'✗'}</span>}
                                {!sessRequired && <span style={{fontSize:'0.72rem',color:'rgba(255,179,217,.25)'}}>rest day</span>}
                              </div>
                            ...
                            <div style={{textAlign:'right'}}>
                              {glowEarned>0&&<div style={{color:T.a1,fontSize:'0.68rem'}}>+{glowEarned} GP</div>}
                              {grindEarned>0&&<div style={{color:'#ff3d9a',fontSize:'0.68rem'}}>+{grindEarned} GP</div>}
                            </div>
                          </div>
                        </div>
                      );
                    ...
                    {/* Perfect week progress */}
                    {!weekWrapData.perfectWeekApplied && (
                      <div style={Object.assign({},cardS,{padding:'14px',marginTop:4})}>
                        <div style={{color:T.a1,fontFamily:'Playfair Display,serif',fontSize:'0.88rem',fontWeight:'bold',marginBottom:8}}>Perfect Week Progress</div>
                        <div style={{color:'rgba(255,179,217,.5)',fontSize:'0.78rem',fontFamily:'Crimson Text,serif',lineHeight:1.6}}>
                          Need: 2+ challenges every day + all gym and ride sessions completed.
                        </div>
                        <div style={{marginTop:10,display:'flex',gap:6,flexWrap:'wrap'}}>
                          {ACTIVE_TRAINING_DAYS.map(function(dayId){ var done=weekWrapData.trainingSessions[dayId]; return <div key={dayId} style={{padding:'4px 10px',borderRadius:20,fontSize:'0.68rem',background:done?'rgba(255,45,120,.15)':'rgba(255,255,255,.04)',border:'1px solid '+(done?'rgba(255,45,120,.3)':'rgba(255,120,190,.12)'),color:done?'#ff3d9a':'rgba(255,179,217,.35)'}}>💪 {dayId.charAt(0).toUpperCase()+dayId.slice(1)} {done?'✓':'✗'}</div>; })}
                        </div>
                      </div>
                    )}
                  </div>
                ...
                {st.atab==='Rewards' && (
                  <div>
                    <p style={{color:'rgba(255,179,217,.4)',fontSize:'0.78rem',fontFamily:'Crimson Text,serif',marginBottom:14,lineHeight:1.5}}>Add rewards Rebecca can redeem with her points. Set the cost and which point type she needs to spend.</p>
                    ...
                    <div style={Object.assign({},cardS,{padding:'16px',marginBottom:16})}>
                      ...
                      <div style={{display:'grid',gridTemplateColumns:'60px 1fr',gap:9,marginBottom:10}}>
                        <div><div style={lblS}>Emoji</div><input value={st.rewardForm.emoji} onChange={function(e){setSt(function(p){return Object.assign({},p,{rewardForm:Object.assign({},p.rewardForm,{emoji:e.target.value})});});}} style={Object.assign({},inpS,{textAlign:'center',fontSize:'1.3rem',padding:'10px 6px'})} maxLength={2}/></div>
                        <div><div style={lblS}>Reward Title</div><input placeholder='e.g. Takeaway of your choice' value={st.rewardForm.title} onChange={function(e){setSt(function(p){return Object.assign({},p,{rewardForm:Object.assign({},p.rewardForm,{title:e.target.value}),rewardFormErr:''});});}} style={inpS}/></div>
                      </div>
                      <div style={{marginBottom:10}}><div style={lblS}>Description (optional)</div><input placeholder='Any details or conditions...' value={st.rewardForm.desc} onChange={function(e){setSt(function(p){return Object.assign({},p,{rewardForm:Object.assign({},p.rewardForm,{desc:e.target.value})});});}} style={inpS}/></div>
                      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:9,marginBottom:12}}>
                        <div>
                          <div style={lblS}>Point Type</div>
                          <div style={{display:'flex',gap:6}}>
                            {[['glow','✨ Glow'],['grind','💪 Grind']].map(function(pair){ var sel=st.rewardForm.pointType===pair[0]; return <button key={pair[0]} onClick={function(){setSt(function(p){return Object.assign({},p,{rewardForm:Object.assign({},p.rewardForm,{pointType:pair[0]})});});}} style={{flex:1,padding:'10px 6px',borderRadius:10,border:'1px solid '+(sel?T.a1+'66':'rgba(255,120,190,.2)'),background:sel?T.a1+'18':'transparent',color:sel?T.a1:'rgba(255,179,217,.4)',cursor:'pointer',fontSize:'0.76rem',fontFamily:'Playfair Display,serif',fontWeight:sel?'bold':'normal',touchAction:'manipulation'}}>{pair[1]}</button>; })}
                          </div>
                        </div>
                        <div>
                          <div style={lblS}>Cost (points)</div>
                          <input type='number' min='1' value={st.rewardForm.cost} onChange={function(e){setSt(function(p){return Object.assign({},p,{rewardForm:Object.assign({},p.rewardForm,{cost:Number(e.target.value)})});});}} style={inpS}/>
                        </div>
                      </div>
                      ...
                      <button style={gbS} onClick={function() {
                        if (!st.rewardForm.title.trim()) { setSt(function(p){return Object.assign({},p,{rewardFormErr:'Add a title'});}); return; }
                        if (!st.rewardForm.cost || st.rewardForm.cost < 1) { setSt(function(p){return Object.assign({},p,{rewardFormErr:'Set a cost'})}); return; }
                        var newReward = { id:'r-'+Date.now(), emoji:st.rewardForm.emoji, title:st.rewardForm.title.trim(), desc:st.rewardForm.desc.trim(), pointType:st.rewardForm.pointType, cost:Number(st.rewardForm.cost), redeemed:false, createdAt:new Date().toISOString() };
                        setSt(function(p){ return Object.assign({},p,{rewards:p.rewards.concat([newReward]),rewardForm:{emoji:'🎁',title:'',desc:'',pointType:'glow',cost:50},rewardFormErr:''}); });
                      }}>Add Reward 🎁</button>
                    </div>
                    ...
                    {st.rewards.length > 0 && (
                      <div>
                        <div style={lblS}>Current Rewards ({st.rewards.length})</div>
                        <div style={{display:'flex',flexDirection:'column',gap:9,marginTop:6}}>
                          {st.rewards.map(function(r) {
                            var isGlow = r.pointType === 'glow';
                            var ptColor = isGlow ? T.a1 : '#ff3d9a';
                            return (
                              <div key={r.id} style={Object.assign({},cardS,{padding:'13px 14px',opacity:r.redeemed?.5:1,border:r.redeemed?'1px solid rgba(255,120,190,.1)':'1px solid rgba(255,120,190,.18)'})}>
                                <div style={{display:'flex',alignItems:'center',gap:10}}>
                                  <span style={{fontSize:'1.4rem'}}>{r.emoji}</span>
                                  <div style={{flex:1,minWidth:0}}>
                                    <div style={{color:'#ffe8f5',fontFamily:'Playfair Display,serif',fontSize:'0.86rem',fontWeight:'bold',textDecoration:r.redeemed?'line-through':'none'}}>{r.title}</div>
                                    <div style={{display:'flex',gap:8,alignItems:'center',marginTop:3,flexWrap:'wrap'}}>
                                      <span style={{color:ptColor,fontSize:'0.68rem',fontWeight:'bold'}}>{r.cost} {isGlow?'✨ Glow':'💪 Grind'}</span>
                                      {r.redeemed && <span style={{color:'rgba(255,179,217,.35)',fontSize:'0.64rem',fontStyle:'italic'}}>redeemed</span>}
                                    </div>
                                  </div>
                                  <div style={{display:'flex',gap:6}}>
                                    {r.redeemed && (
                                      <button onClick={function(){setSt(function(p){return Object.assign({},p,{rewards:p.rewards.map(function(x){return x.id===r.id?Object.assign({},x,{redeemed:false,redeemedAt:null}):x;})});});}} style={{background:'transparent',border:'1px solid rgba(255,120,190,.2)',borderRadius:8,color:'rgba(255,179,217,.4)',cursor:'pointer',fontSize:'0.64rem',padding:'4px 8px',touchAction:'manipulation'}}>Restore</button>
                                    )}
                                    <button onClick={function(){if(window.confirm('Delete this reward?'))setSt(function(p){return Object.assign({},p,{rewards:p.rewards.filter(function(x){return x.id!==r.id;})});});}} style={{background:'transparent',border:'none',color:'rgba(255,100,100,.34)',cursor:'pointer',fontSize:'0.8rem',padding:'4px',touchAction:'manipulation'}}>🗑️</button>
                                  </div>
                                </div>
                                {r.desc && <div style={{color:'rgba(255,179,217,.35)',fontSize:'0.72rem',fontFamily:'Crimson Text,serif',marginTop:4,marginLeft:42}}>{r.desc}</div>}
                              </div>
                            );
                          })}
                        </div>
                ...
                {st.atab==='Settings' && (
                  <div>
                    ...
                    <div style={Object.assign({},cardS,{padding:'14px',marginBottom:11})}>
                      <div style={lblS}>Notification Times</div>
                      <div style={{marginBottom:10}}><div style={{color:'rgba(255,179,217,.4)',fontSize:'0.72rem',marginBottom:5,fontFamily:'Crimson Text,serif'}}>Challenge nudge (if 2 not done)</div><input type='time' value={st.challengeNudgeTime} onChange={function(e){setSt(function(p){return Object.assign({},p,{challengeNudgeTime:e.target.value});});}} style={Object.assign({},inpS,{colorScheme:'dark'})}/></div>
                      <div><div style={{color:'rgba(255,179,217,.4)',fontSize:'0.72rem',marginBottom:5,fontFamily:'Crimson Text,serif'}}>Training nudge (gym and ride days)</div><input type='time' value={st.trainingNudgeTime} onChange={function(e){setSt(function(p){return Object.assign({},p,{trainingNudgeTime:e.target.value});});}} style={Object.assign({},inpS,{colorScheme:'dark'})}/></div>
                    </div>
                    <div style={Object.assign({},cardS,{padding:'14px',marginBottom:11})}>
                      <div style={lblS}>Grind Levels</div>
                      {GRIND_LEVELS.map(function(l){ var r=st.grindPoints>=l.threshold; var cur=l.level===grindLvi.level; return <div key={l.level} style={{display:'flex',alignItems:'center',gap:9,marginBottom:9,opacity:r?1:.34}}><span>{l.emoji}</span><div style={{flex:1}}><div style={{color:r?l.color:'rgba(255,179,217,.38)',fontFamily:'Playfair Display,serif',fontSize:'0.8rem',fontWeight:'bold'}}>{l.title}{cur?' (current)':''}</div><div style={{color:'rgba(255,179,217,.26)',fontSize:'0.58rem'}}>Unlocks at {l.threshold} Grind Pts</div></div>{r&&<span style={{color:l.color,fontSize:'0.76rem'}}>✓</span>}</div>; })}
                    </div>
                    <div style={{borderTop:'1px solid rgba(255,120,190,.1)',paddingTop:16,marginBottom:10}}>
                      <div style={lblS}>Danger Zone</div>
                      <button onClick={function(){if(window.confirm('Reset ALL progress including points and perfect weeks?'))setSt(function(p){return Object.assign({},p,{glowPoints:0,grindPoints:0,seen:[],ch:[],lgd:null,hist:{},streak:0,lsd:null,cats:{},earned:[],wplan:{},weeklyData:{},perfectWeeks:0,pb:{bestGlowWeek:0,bestGrindWeek:0,bestPerfectStreak:0,mostChallengesDay:0}});});setTChecked({});setRidesDone({});}} style={{background:'transparent',border:'1px solid rgba(255,60,60,.22)',color:'rgba(255,100,100,.4)',borderRadius:12,padding:11,cursor:'pointer',fontSize:'0.8rem',fontFamily:'Crimson Text,serif',width:'100%',marginBottom:8,touchAction:'manipulation'}}>Reset All Progress</button>
                    </div>
                    <button onClick={function(){setSt(function(p){return Object.assign({},p,{unlocked:false,view:'her'});});}} style={Object.assign({},sbS(false),{width:'100%',padding:'11px'})}>Lock and Return</button>
                  </div>
                )}
          ...
          <div style={{fontFamily:'Poppins,sans-serif',color:'#F5E8EF',animation:'up .3s ease-out'}}>
            ...
            <div style={{padding:'52px 22px 18px'}}>
              ...
              <div style={{display:'flex',alignItems:'flex-end',justifyContent:'space-between'}}>
                ...
                <div style={{textAlign:'right'}}>
                  <div style={{fontSize:13,fontWeight:700,color:'#FF2D78'}}>{st.grindPoints}</div>
                  <div style={{fontSize:8,color:'#5A3545',letterSpacing:1}}>GRIND PTS</div>
                  <div style={{fontSize:9,color:grindLvi.color,marginTop:2}}>{grindLvi.emoji} {grindLvi.title}</div>
                </div>
              </div>
            </div>
            ...
            <div style={{padding:'0 20px',animation:'slideUp 0.2s ease'}} key={tDay}>
              <div style={{background:'rgba(255,45,120,0.1)',border:'1px solid rgba(255,45,120,0.22)',borderRadius:18,padding:'18px 18px 14px',marginBottom:12,position:'relative',overflow:'hidden'}}>
                ...
                <div style={{fontSize:24,fontWeight:700,color:'white',lineHeight:1.1}}>{SESSIONS[tDay].title}</div>
                {/* Points badge */}
                {(SESSIONS[tDay].isGym||SESSIONS[tDay].isRide) && (
                  <div style={{marginTop:8,display:'inline-flex',alignItems:'center',gap:6,background:'rgba(255,45,120,0.15)',borderRadius:20,padding:'4px 12px'}}>
                    <span style={{fontSize:11,color:'#FF85AD',fontWeight:600}}>💪 +{SESSIONS[tDay].isGym?GRIND_GYM:GRIND_RIDE} Grind Pts on completion</span>
                  </div>
                )}
                {tTotalExs>0 && <div style={{marginTop:10}}>
              ...
              {SESSIONS[tDay].isRide && (
                <div>
                  ...
                  {isSessionDone(tDay) ? (
                    <div style={{background:'rgba(255,45,120,0.1)',border:'1px solid rgba(255,45,120,0.3)',borderRadius:16,padding:'16px',textAlign:'center',color:'#FF2D78',fontWeight:700,fontSize:14}}>Ride Done! +{GRIND_RIDE} Grind Pts ✓</div>
                  ) : tDay === todayDayId ? (
                    <button onClick={function(){ completeTrainingSession(tDay); }} style={{width:'100%',background:'linear-gradient(135deg,#FF2D78,#CC0044)',border:'none',borderRadius:16,padding:'16px',color:'white',fontFamily:'Poppins,sans-serif',fontSize:14,fontWeight:700,cursor:'pointer',touchAction:'manipulation',boxShadow:'0 4px 20px rgba(255,45,120,0.4)'}}>Mark Ride Complete +{GRIND_RIDE} Grind Pts</button>
                  ) : (
                    <div style={{background:'rgba(255,255,255,0.04)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:16,padding:'16px',textAlign:'center',color:'rgba(255,179,217,.3)',fontSize:13}}>Ride not logged for this day</div>
                  )}
                </div>
              )}
              ...
              {SESSIONS[tDay].isGym && (
                <div>
                  {SESSIONS[tDay].warmup && <div style={{marginBottom:14}}>
                  ...
                  <div style={{display:'flex',flexDirection:'column',gap:7}}>
                    {SESSIONS[tDay].exercises.map(function(ex,i){ var ek=tDay+'-'+i; var edone=!!tChecked[ek];
                      return <div key={i} className='tappable' onClick={function(){setTChecked(function(p){return Object.assign({},p,{[ek]:!p[ek]});});}} style={{background:edone?'rgba(255,45,120,0.07)':'rgba(255,255,255,0.04)',border:edone?'1px solid rgba(255,45,120,0.28)':'1px solid rgba(255,255,255,0.07)',borderRadius:14,padding:'13px 14px',display:'flex',alignItems:'center',gap:12}}>
                        ...
                        <div style={{flex:1,minWidth:0}}><div style={{fontSize:13,fontWeight:600,color:edone?'#4A2535':'white',textDecoration:edone?'line-through':'none',marginBottom:2,lineHeight:1.2}}>{ex.name}</div><div style={{fontSize:11,color:edone?'#3A1A28':'#6A4055',fontWeight:300,lineHeight:1.3}}>{ex.note}</div></div>
  ...
  return newChecked;
        ...
        {tab==='rewards' && (
          <div style={{padding:'0 15px',animation:'up .3s ease-out'}}>
            ...
            <div style={{display:'flex',gap:10,marginBottom:18}}>
              <div style={Object.assign({},cardS,{flex:1,padding:'14px',textAlign:'center'})}>
                <div style={{fontSize:'1.6rem',fontFamily:'Playfair Display,serif',fontWeight:900,color:T.a1}}>{st.glowPoints}</div>
                <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.62rem',textTransform:'uppercase',letterSpacing:'0.1em',marginTop:3}}>✨ Glow Points</div>
              </div>
              <div style={Object.assign({},cardS,{flex:1,padding:'14px',textAlign:'center'})}>
                <div style={{fontSize:'1.6rem',fontFamily:'Playfair Display,serif',fontWeight:900,color:'#ff3d9a'}}>{st.grindPoints}</div>
                <div style={{color:'rgba(255,179,217,.4)',fontSize:'0.62rem',textTransform:'uppercase',letterSpacing:'0.1em',marginTop:3}}>💪 Grind Points</div>
              </div>
            </div>

            {st.rewards.length === 0 ? (
              <div style={{textAlign:'center',padding:'50px 20px',color:'rgba(255,179,217,.26)',fontStyle:'italic',fontFamily:'Crimson Text,serif',lineHeight:1.7}}>
                No rewards yet 🌸<br/>Sam will add some for you to unlock
              </div>
            ) : (
              <div style={{display:'flex',flexDirection:'column',gap:12}}>
                {st.rewards.map(function(r) {
                  ...
                  return (
                    <div key={r.id} style={Object.assign({},cardS,{padding:'18px',border:redeemed?'1px solid rgba(255,120,190,.1)':canAfford?'1px solid '+T.a1+'44':'1px solid rgba(255,120,190,.13)',opacity:redeemed?0.45:1})}>
                      <div style={{display:'flex',alignItems:'flex-start',gap:14}}>
                        ...
                        <div style={{flex:1,minWidth:0}}>
                          ...
                          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:8}}>
                            <div style={{display:'flex',alignItems:'center',gap:6,background:ptColor+'14',border:'1px solid '+ptColor+'30',borderRadius:20,padding:'4px 12px'}}>
                            ...
                            {redeemed ? (
                              <div style={{fontSize:'0.75rem',color:'rgba(255,179,217,.35)',fontFamily:'Crimson Text,serif',fontStyle:'italic'}}>Redeemed ✓</div>
                            ) : (
                              <button onClick={function() {
                                if (!canAfford) return;
                                if (!window.confirm('Redeem ' + r.title + ' for ' + r.cost + ' ' + (isGlow?'Glow':'Grind') + ' Points?')) return;
                                setSt(function(p) {
                                  var newRewards = p.rewards.map(function(x){ return x.id===r.id ? Object.assign({},x,{redeemed:true,redeemedAt:new Date().toISOString()}) : x; });
                                  var newGlow = isGlow ? Math.max(0,p.glowPoints-r.cost) : p.glowPoints;
                                  var newGrind = !isGlow ? Math.max(0,p.grindPoints-r.cost) : p.grindPoints;
                                  return Object.assign({},p,{rewards:newRewards,glowPoints:newGlow,grindPoints:newGrind});
                                });
                              }} style={{background:canAfford?'linear-gradient(135deg,'+T.a1+','+T.a2+')':'rgba(255,255,255,.06)',border:'none',borderRadius:20,color:canAfford?'#fff':'rgba(255,179,217,.25)',fontFamily:'Playfair Display,serif',fontSize:'0.78rem',fontWeight:'bold',padding:'7px 16px',cursor:canAfford?'pointer':'not-allowed',touchAction:'manipulation',boxShadow:canAfford?'0 0 14px '+T.a1+'44':'none'}}>
        ...
        <div style={{position:'fixed',bottom:0,left:'50%',transform:'translateX(-50%)',width:'100%',maxWidth:520,zIndex:100}}>
          <div style={{background:'linear-gradient(0deg,'+T.bg+' 55%,transparent)',padding:'14px 16px 18px',display:'flex',justifyContent:'space-around'}}>
            {[{id:'home',icon:'💖',label:'Home'},{id:'training',icon:'💪',label:'Train'},{id:'nutrition',icon:'🥗',label:'Fuel'},{id:'rewards',icon:'🎁',label:'Rewards'}].map(function(t){ var active=tab===t.id; return <button key={t.id} onClick={function(){setTab(t.id);}} style={{background:'transparent',border:'none',cursor:'pointer',display:'flex',flexDirection:'column',alignItems:'center',gap:3,touchAction:'manipulation',opacity:active?1:0.38,transition:'opacity 0.2s'}}><div style={{fontSize:20}}>{t.icon}</div><div style={{fontSize:8,fontWeight:active?700:400,color:active?T.a1:'rgba(255,179,217,.5)',letterSpacing:1,fontFamily:'Poppins,sans-serif'}}>{t.label.toUpperCase()}</div>{active&&<div style={{width:4,height:4,borderRadius:'50%',background:T.a1,boxShadow:'0 0 6px '+T.a1}}/>}</button>; })}
          </div>
        </div>
      </div>
    </div>
